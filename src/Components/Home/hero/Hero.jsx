    ...
    <>
      <section className='hero'>
        <div className='container'>
          <div className='row'>
              <Title subtitle='BIENVENIDOS A KIDS SCIENTIFIC PARKING' title='Formación Integral' />
            ...
            <p>Bienvenido a nuestro centro de tutorías, donde ofrecemos una educación integral y transformadora en un ambiente seguro y acogedor. Nuestros maestros altamente capacitados brindan una educación de calidad tanto en línea como presencialmente, centrada en valores morales y espirituales. Además, somos un centro de tutorías que ofrece a nuestra pequeña comunidad una adecuada formación académica.</p>
